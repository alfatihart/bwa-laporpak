...
class ReportStatusController extends Controller
{
    ...
    protected ReportStatusRepositoryInterface $reportStatusRepository;
    ...
    public function store(StoreReportStatusRequest $request)
    {
        ...
        Swal::toast('Data Progres Laporan Berhasil Ditambahkan', 'success')->timerProgressBar();
    ...
    public function update(UpdateReportStatusRequest $request, string $id)
    {
        ...
        Swal::toast('Data Progres Laporan Berhasil Diperbarui', 'success')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Data Progres Laporan Berhasil Dihapus', 'success')->timerProgressBar();
